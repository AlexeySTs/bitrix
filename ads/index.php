...
?><div class="pt-5">
 ...
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"LIST_FIELD_CODE" => array("NAME","PREVIEW_PICTURE","CREATED_BY",""),
		"LIST_PROPERTY_CODE" => array("PRICE","SQUARE","COUNT_BATHS","GARAGES","ADDRESS","COUNT_GARAGES","COUNT_BEDS",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "3",
		...
		"PAGER_SHOW_ALL" => "N",
		"PAGER_SHOW_ALWAYS" => "N",
		"PAGER_TEMPLATE" => "test_navigation",
		"PAGER_TITLE" => "Новости",
